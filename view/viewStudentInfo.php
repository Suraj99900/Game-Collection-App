                ...
                <form>
                    <div class="row align-items-center p-3">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <input type="text" class="form-control custom-control " id="studentuserNameId" name="studentname" placeholder="Enter student full name" readonly>
                        </div>
                    </div>
                    <div class="row align-items-center p-3">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <div class="row align-items-center p-3">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <input type="email" class="form-control custom-control " id="emailId" name="studentEmail" placeholder="Enter student Email" readonly>
                        </div>
                    </div>
                    <div class="row align-items-center p-3">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <label for="phone no" class="form-label"><i class="fa-solid fa-phone"></i> Phone No </label>
                            <input type="number" class="form-control custom-control " id="phoneId" name="studentPhoneNo" placeholder="Enter student Phone" readonly>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center p-3">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <select class="form-select custom-control" readonly id="semesterId" name="semester">
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center p-3">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            ...
                            <textarea class="form-control" id="addressid" name="address" placeholder="Enter student Address" readonly cols="30" rows="5"></textarea>
                        </div>
                    </div>
                </form>
            </div>

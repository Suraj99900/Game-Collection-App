<div class="content" style="padding: 16px;">
    <p class="c-text">This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your
        information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
    <h1 class="c-text">Interpretation and Definitions</h1>
    <h2 class="c-text">Interpretation</h2>
    <p class="c-text">The words of which the initial letter is capitalized have meanings defined under the following conditions.</p>
    <p class="c-text">The following definitions shall have the same meaning regardless of whether they appear in singular or in
        plural.
    </p>
    <h2 class="c-text">Definitions</h2>
    <p class="c-text">For the purposes of this Privacy Policy:</p>
    <ul>
        <li>
            <p class="c-text"><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal
                entity on behalf of which such individual is accessing or using the Service, as applicable.</p>
        </li>
        <li>
            <p class="c-text"><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement)
                refers to g-project.in.</p>
        </li>
        ...
        <li><strong>Website</strong> refers to g-project.in, accessible from https://g-project.in</li>
        <li><strong>Service</strong> refers to the Website.</li>
        <li><strong>Country</strong> refers to: Uttar Pradesh, India</li>
        <li>
            <p class="c-text"><strong>Service Provider</strong> means any natural or legal person who processes the data on behalf of
        ...
        <li>
            <p class="c-text"><strong>Personal Data</strong> is any information that relates to an identified or identifiable
                individual.</p>
        </li>
    ...
    <h1 class="c-text">Collecting and Using Your Personal Data</h1>
    <h2 class="c-text">Types of Data Collected</h2>
    <h3 class="c-text">Personal Data</h3>
    <p class="c-text">While using Our Service, We may ask You to provide Us with certain personally identifiable information that can
    ...
    <h3 class="c-text">Usage Data</h3>
    <p class="c-text">Usage Data is collected automatically when using the Service.</p>
    <p class="c-text">Usage Data may include information such as Your Device's Internet Protocol address (e.g. IP address), browser
    ...
    <p class="c-text">When You access the Service by or through a mobile device, We may collect certain information automatically,
    ...
    <p class="c-text">We may also collect information that Your browser sends whenever You visit our Service or when You access the
        Service by or through a mobile device.</p>
    <h3 class="c-text">Tracking Technologies and Cookies</h3>
    <p class="c-text">We use Cookies and similar tracking technologies to track the activity on Our Service and store certain
    ...
    <p class="c-text">You can instruct Your browser to refuse all Cookies or to indicate when a Cookie is being sent. However, if You
        do not accept Cookies, You may not be able to use some parts of our Service.</p>
    <p class="c-text">Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on your personal computer or mobile
        device when You go offline, while Session Cookies are deleted as soon as You close your web browser.
    </p>
    <p class="c-text">We use both session and persistent Cookies for the purposes set out below:</p>
    <ul>
        <li>
            <p class="c-text"><strong>Necessary / Essential Cookies</strong></p>
            <p class="c-text">Type: Session Cookies</p>
            <p class="c-text">Administered by: Us</p>
            <p class="c-text">Purpose: These Cookies are essential to provide You with services available through the Website and to
        ...
        <li>
            <p class="c-text"><strong>Cookies Policy / Notice Acceptance Cookies</strong></p>
            <p class="c-text">Type: Persistent Cookies</p>
            <p class="c-text">Administered by: Us</p>
            <p class="c-text">Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
        </li>
        <li>
            <p class="c-text"><strong>Functionality Cookies</strong></p>
            <p class="c-text">Type: Persistent Cookies</p>
            <p class="c-text">Administered by: Us</p>
            <p class="c-text">Purpose: These Cookies allow us to remember choices You make when You use the Website, such as
    ...
    <p class="c-text">For more information about the cookies we use and your choices regarding cookies, please visit our Cookies
        Policy.</p>
    <h2 class="c-text">Use of Your Personal Data</h2>
    <p class="c-text">The Company may use Personal Data for the following purposes:</p>
    <ul>
    ...
    <p class="c-text">We may share your personal information in the following situations:</p>
    <ul>
    ...
    <h2 class="c-text">Retention of Your Personal Data</h2>
    <p class="c-text">The Company will retain Your Personal Data only for as long as is necessary for the purposes set out in this
        Privacy Policy. We will retain and use Your Personal Data to the extent necessary to comply with our legal
        obligations (for example, if we are required to retain your data to comply with applicable laws), resolve
        disputes, and enforce our legal agreements and policies.</p>
    <p class="c-text">The Company will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a
    ...
    <h2 class="c-text">Transfer of Your Personal Data</h2>
    <p class="c-text">Your information, including Personal Data, is processed at the Company's operating offices and in any other
    ...
    <p class="c-text">Your consent to this Privacy Policy followed by Your submission of such information represents Your agreement
        to
        that transfer.</p>
    <p class="c-text">The Company will take all steps reasonably necessary to ensure that Your data is treated securely and in
        ...
        information.</p>
    <h2 class="c-text">Disclosure of Your Personal Data</h2>
    <h3 class="c-text">Business Transactions</h3>
    <p class="c-text">If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We
        will
        provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
    <h3 class="c-text">Law enforcement</h3>
    <p class="c-text">Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by
        law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
    <h3 class="c-text">Other legal requirements</h3>
    <p class="c-text">The Company may disclose Your Personal Data in the good faith belief that such action is necessary to:</p>
    <ul>
    ...
    <h2 class="c-text">Security of Your Personal Data</h2>
    <p class="c-text">The security of Your Personal Data is important to Us, but remember that no method of transmission over the
    ...
    <h1 class="c-text">Children's Privacy</h1>
    <p class="c-text">Our Service does not address anyone under the age of 13. We do not knowingly collect personally identifiable
    ...
    <p class="c-text">If We need to rely on consent as a legal basis for processing Your information and Your country requires
        consent
        from a parent, We may require Your parent's consent before We collect and use that information.</p>
    <h1 class="c-text">Links to Other Websites</h1>
    <p class="c-text">Our Service may contain links to other websites that are not operated by Us. If You click on a third party
        link,
        You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every
        site You visit.</p>
    <p class="c-text">We have no control over and assume no responsibility for the content, privacy policies or practices of any
        third
        party sites or services.</p>
    <h1 class="c-text">Changes to this Privacy Policy</h1>
    <p class="c-text">We may update our Privacy Policy from time to time. We will notify You of any changes by posting the new
        Privacy
        Policy on this page.</p>
    <p class="c-text">We will let You know via email and/or a prominent notice on Our Service, prior to the change becoming effective
        and update the "Last updated" date at the top of this Privacy Policy.</p>
    <p class="c-text">You are advised to review this Privacy Policy periodically for any changes. Changes to this Privacy Policy are
        effective when they are posted on this page.</p>
    <h1 class="c-text">Contact Us</h1>
    <p class="c-text">If you have any questions about this Privacy Policy, You can contact us:</p>
    <ul>
        <li>By visiting this page on our website: https://g-project.in/#/suggestion</li>
    </ul>
</div>
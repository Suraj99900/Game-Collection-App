                ...
                <div class="card shadow bg-card-low row StaffInfo padd-15">
                    <div class="row align-items-center p-3" id="accountDetailsId">
                        <div class="col-sm-12 col-md-6 col-lg-4 my-3">
                            <a href="adminWinManagement.php" class="card p-3 shadow" style="height: 200px;">
                                <div class="icon-fa padd-15">
                                    <h4><i class="fa-solid fa-wine-glass-empty"></i></h4>
                                </div>
                                <div class="labelbox padd-15 mt-1">
                                    <h4>Win Game</h4>
                                </div>
                                <div class="count padd-15 mt-1">
                                    <p>Time : <span id="timeId" style="color: var(--skin-color);">0</span> </p>
                                    <p>Current Peroid: <span id="currentPeroidId"
                                            style="color: var(--skin-color);">0</span> </p>
                                </div>
                            </a>
                        </div>
                    </div>

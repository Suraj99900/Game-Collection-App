...
$iMasterBookId = $_GET['masterFolderId'] ? $_GET['masterFolderId'] : 0;
$iMasterBookName = $_GET['masterFolderName'] ? $_GET['masterFolderName'] : "";
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="section-title padd-15">
                    <h2><?php echo $iMasterBookName; ?></h2>
                </div>
            </div>
            <div class="shadow-lg p-sm-1 p-md-2 p-lg-5 mb-lg-5 mb-md-5 mb-sm-2 rounded">
                ...
                <div class="row align-items-center p-3" id="idsubFolder">
...
<script>
var iMasterFolderId = <?php echo $iMasterBookId; ?>;
$(document).ready(() => {

        ...
        <div class="dashboard dashboard_container">
            ...
            <aside>
                <ul>
                    ...
                    <li>
                        <a href="about.php?iActive=3" class="shadow-lg p-3 mb-5 rounded active"><i
                                class="fa-solid fa-tarp"></i>
                            <h5>About</h5>
                        </a>
                    </li>
            ...
            <main>
                <div class="card shadow bg-card-low col userInfo padd-15">
                    <div class="row">
                        <h3 class="col-lg-4 col-md-4 col-sm-12 my-4" style="text-align: center;"><a class="c-text badge" data-bs-toggle="collapse" href="#collapseAllId" role="button"
                                aria-expanded="true" aria-controls="collapseAllId">
                                Privacy Policy
                            </a></h3>
                        <h3 class="col-lg-4 col-md-4 col-sm-12 my-4" style="text-align: center;"><a class="c-text badge " data-bs-toggle="collapse" href="#collapseSuccessfulId" role="button"

...
if ($category == 'parity') { ?>
    <div class="containerrecord text-center">
        <a href="#" class="recordlink">
            <p> <i class="icon ion-md-trophy"></i>
                ...
                <?php
                    ...
                    while ($parityResult = mysqli_fetch_array($parityrecordQuery)) {
                        if ($parityResult['resulttype'] == 'real') {
                            ...
                            <tr>
                                <td>
                                    <?php echo $parityResult['periodid']; ?>
                                </td>
                                <td>
                                    <?php echo $parityResult['randomprice']; ?>
                                </td>
                                <td><span
                                        style="color:<?php if ($parityResult['color'] == 'green') {
                                            echo "#1DCC70";
                        ...
                        <?php } else if ($parityResult['resulttype'] == 'random') { ?>
                                <tr>
                                    ...
                                    <td><span
                                            style="color:<?php if ($parityResult['randomcolor'] == 'green') {
                                                echo "#1DCC70";
                                        ...
                                        <?php echo $parityResult['randomresult']; ?>
                                        </span></td>
                                    <td>
                                        <div style="display: flex;">
                                            <div class="spacer"></div>
    ...
    <div class="containerrecord text-center mt-1">
        <a href="#" class="recordlink">
            <p> <i class="icon ion-md-paper"></i>
                <div class="title">My Parity Record</div>
            </p>
        </a>
    </div>
        ...
        <table class="table table-borderless" id="myrecordparityt">
            ...
            <tbody>
                ...
                while ($userResult = mysqli_fetch_array($userResultQuery)) {
                    ...
                    ?>
                    <tr data-toggle="collapse" data-target="#accordion<?php echo ($userResult['id']); ?>" class="clickable"
                        style="border-bottom:1px solid #ccc;">
                        <td class="pl-3" style="border:none;">
                            <?php echo ($userResult['periodid']); ?> <span
                                style="color:<?php if ($userResult['status'] == 'success') {
                                    echo "#1DCC70";
                                } else {
                                    echo "#ff2d55";
                                } ?>">
                                ...
                                <?php echo number_format($userResult['paidamount'], 2); ?>
                            </span>
                            <div id="accordion<?php echo ($userResult['id']); ?>" class="detail collapse mt-1 mb-1 p-1"
                                ...
                                <div class="mt-1" style="display: flex;">
                                    ...
                                    <div class="point2">
                                        <?php echo number_format($userResult['amount'] - $userResult['fee'], 2); ?>
                                    </div>
                                </div>
                                <div class="mt-1" style="display: flex;">
...
<?php } else if ($category == 'sapre') { ?>
        <div class="containerrecord text-center">
            <a href="gamedashboard.php" class="recordlink">
                <p> <i class="icon ion-md-trophy"></i>
                    <div class="title">Sapre Record</div>
                </p>
            </a>
        </div>
        <div class="table-container">
                ...
                <?php
                        ...
                        while ($sapreResult = mysqli_fetch_array($saprerecordQuery)) {
                            if ($sapreResult['resulttype'] == 'real') {
                                ...
                                <tr>
                                    <td>
                                    <?php echo $sapreResult['periodid']; ?>
                                    </td>
                                    <td>
                                    <?php echo $sapreResult['randomprice']; ?>
                                    </td>
                                    <td><span
                                            style="color:<?php if ($sapreResult['color'] == 'green') {
                                                echo "#1DCC70";
                        ...
                        <?php } else if ($sapreResult['resulttype'] == 'random') { ?>
                                    ...
                                    <?php echo $sapreResult['randomprice']; ?>
                                        ...
                                        <td><span
                                                style="color:<?php if ($sapreResult['randomcolor'] == 'green') {
                                                    echo "#1DCC70";
                                        ...
                                        <?php echo $sapreResult['randomresult']; ?>
                                            </span></td>
                                        <td>
                                            <div style="display: flex;">
                                                <div class="spacer"></div>
        ...
        <div class="containerrecord text-center mt-1">
            <a href="#" class="recordlink">
                <p> <i class="icon ion-md-paper"></i>
                    <div class="title">My Sapre Record</div>
                </p>
            </a>
        </div>
        <div class="table-container">
            <table class="table table-borderless" id="myrecordsapret">
                ...
                <tbody>
                    ...
                    while ($userResult = mysqli_fetch_array($userResultQuery)) {
                        ...
                        ?>
                        <tr data-toggle="collapse" data-target="#accordionsapre<?php echo ($userResult['id']); ?>" class="clickable"
                            style="border-bottom:1px solid #ccc;">
                            <td class="pl-3" style="border:none;">
                            <?php echo ($userResult['periodid']); ?> <span
                                    style="color:<?php if ($userResult['status'] == 'success') {
                                ...
                                <div id="accordionsapre<?php echo ($userResult['id']); ?>" class="detail collapse mt-1 mb-1 p-1"
                                    style="padding:0px 30px;">
                                    <span style="color:#1DCC70"> Period Detail</span>
                                    <div class="mt-1" style="display: flex;">
                                        <div class="point2">Periodid</div>
...
<?php
    ...
    ?>
            <div class="containerrecord text-center">
                <a href="gamedashboard.php" class="recordlink">
                    <p> <i class="icon ion-md-trophy"></i>
                        <div class="title">Bcone Record</div>
                    </p>
                </a>
            </div>
            <div class="table-container">
                ...
                <?php
                        ...
                        while ($bconeResult = mysqli_fetch_array($bconerecordQuery)) {
                            if ($bconeResult['resulttype'] == 'real') {
                                ?>
                                    <tr>
                                        <td>
                                    <?php echo $bconeResult['periodid']; ?>
                                        </td>
                                        <td>
                                    <?php echo $bconeResult['randomprice']; ?>
                                        </td>
                                        <td><span
                                                style="color:<?php if ($bconeResult['color'] == 'green') {
                                                    echo "#1DCC70";
                        ...
                        <?php } else if ($bconeResult['resulttype'] == 'random') { ?>
                                    ...
                                    <?php echo $bconeResult['randomprice']; ?>
                                            ...
                                            <td><span
                                                    style="color:<?php if ($bconeResult['randomcolor'] == 'green') {
                                                        echo "#1DCC70";
                                        ...
                                        <?php echo $bconeResult['randomresult']; ?>
                                                </span></td>
                                            <td>
                                                <div style="display: flex;">
                                                    <div class="spacer"></div>
            ...
            <div class="containerrecord text-center mt-1">
                <a href="#" class="recordlink">
                    <p> <i class="icon ion-md-paper"></i>
                        <div class="title">My Bcone Record</div>
                    </p>
                </a>
            </div>
            <div class="table-container">
                <table class="table table-borderless" id="myrecordbconet">
                    ...
                    while ($userResult = mysqli_fetch_array($userResultQuery)) {
                        ...
                        ?>
                            <tr data-toggle="collapse" data-target="#accordionbcone<?php echo ($userResult['id']); ?>" class="clickable"
                                style="border-bottom:1px solid #ccc;">
                                <td class="pl-3" style="border:none;">
                            <?php echo ($userResult['periodid']); ?> <span
                                        style="color:<?php if ($userResult['status'] == 'success') {
                                ...
                                <?php echo number_format($userResult['paidamount'], 2); ?>
                                    ...
                                    <div id="accordionbcone<?php echo ($userResult['id']); ?>" class="detail collapse mt-1 mb-1 p-1"
                                        style="padding:0px 30px;">
                                        <span style="color:#1DCC70"> Period Detail</span>
                                        <div class="mt-1" style="display: flex;">
                                            <div class="point2">Periodid</div>
    ...
    ?>
                <div class="containerrecord text-center">
                    <a href="gamedashboard.php" class="recordlink">
                        <p> <i class="icon ion-md-trophy"></i>
                            <div class="title">Emerd Record</div>
                        </p>
                    </a>
                </div>
                <div class="table-container">
                ...
                <?php
                        ...
                        while ($emerdResult = mysqli_fetch_array($emerdrecordQuery)) {
                            if ($emerdResult['resulttype'] == 'real') {
                                ?>
                                        <tr>
                                            <td>
                                    <?php echo $emerdResult['periodid']; ?>
                                            </td>
                                            <td>
                                    <?php echo $emerdResult['randomprice']; ?>
                                            </td>
                                            <td><span
                                                    style="color:<?php if ($emerdResult['color'] == 'green') {
                                                        echo "#1DCC70";
                        ...
                        <?php } else if ($emerdResult['resulttype'] == 'random') { ?>
                                    ...
                                    <?php echo $emerdResult['randomprice']; ?>
                                                ...
                                                <td><span
                                                        style="color:<?php if ($emerdResult['randomcolor'] == 'green') {
                                                            echo "#1DCC70";
                                        ...
                                        <?php echo $emerdResult['randomresult']; ?>
                                                    </span></td>
                                                <td>
                                                    <div style="display: flex;">
                                                        <div class="spacer"></div>
                ...
                <div class="containerrecord text-center mt-1">
                    <a href="#" class="recordlink">
                        <p> <i class="icon ion-md-paper"></i>
                            <div class="title">My Emerd Record</div>
                        </p>
                    </a>
                </div>
                <div class="table-container">
                    ...
                    while ($userResult = mysqli_fetch_array($userResultQuery)) {
                        ...
                        ?>
                                <tr data-toggle="collapse" data-target="#accordionemerd<?php echo ($userResult['id']); ?>" class="clickable"
                                    style="border-bottom:1px solid #ccc;">
                                    <td class="pl-3" style="border:none;">
                            <?php echo ($userResult['periodid']); ?> <span
                                            style="color:<?php if ($userResult['status'] == 'success') {
                                ...
                                <?php echo number_format($userResult['paidamount'], 2); ?>
                                        ...
                                        <div id="accordionemerd<?php echo ($userResult['id']); ?>" class="detail collapse mt-1 mb-1 p-1"
                                            style="padding:0px 30px;">
                                            <span style="color:#1DCC70"> Period Detail</span>
                                            <div class="mt-1" style="display: flex;">
                                                <div class="point2">Periodid</div>
